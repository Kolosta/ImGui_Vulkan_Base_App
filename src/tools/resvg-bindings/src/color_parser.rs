...
//     pub property: String,  // "fill", "stroke", "stop-color"
//     pub color_rgba: u32,   // RGBA format
...
// impl ColorParser {
//     /// Parse color from various formats: #RGB, #RRGGBB, #RRGGBBAA, rgb(), rgba(), named colors
...
//             return Some(0x00000000); // Fully transparent
//         }
        
//         // Handle named colors
//         if let Some(rgba) = Self::parse_named_color(trimmed) {
//             return Some(rgba);
//         }
        
//         // Handle hex colors
//         if trimmed.starts_with('#') {
//             return Self::parse_hex_color(&trimmed[1..]);
//         }
        
//         // Handle rgb() and rgba()
//         if trimmed.starts_with("rgb(") || trimmed.starts_with("rgba(") {
//             return Self::parse_rgb_color(trimmed);
//         }
...
//                 Some(0xFF000000 | ((b as u32) << 16) | ((g as u32) << 8) | (r as u32))
//             }
//             6 => {
//                 // #RRGGBB
...
//                 Some(((a as u32) << 24) | ((b as u32) << 16) | ((g as u32) << 8) | (r as u32))
//             }
//             _ => None
//         }
//     }
...
//                 (values[3].parse::<f32>().ok()? * 255.0) as u8
//             } else {
//                 255
//             };
...
//         let colors = Self::named_colors();
//         colors.get(name.to_lowercase().as_str()).copied()
//     }
    
//     fn named_colors() -> HashMap<&'static str, u32> {
//         let mut map = HashMap::new();
        
//         // Common SVG named colors (RGBA format)
//         map.insert("black", 0xFF000000);
//         map.insert("white", 0xFFFFFFFF);
//         map.insert("red", 0xFFFF0000);
//         map.insert("green", 0xFF008000);
//         map.insert("blue", 0xFF0000FF);
//         map.insert("yellow", 0xFFFFFF00);
//         map.insert("cyan", 0xFF00FFFF);
//         map.insert("magenta", 0xFFFF00FF);
//         map.insert("gray", 0xFF808080);
//         map.insert("grey", 0xFF808080);
//         map.insert("silver", 0xFFC0C0C0);
//         map.insert("maroon", 0xFF800000);
//         map.insert("olive", 0xFF808000);
//         map.insert("lime", 0xFF00FF00);
//         map.insert("aqua", 0xFF00FFFF);
//         map.insert("teal", 0xFF008080);
//         map.insert("navy", 0xFF000080);
//         map.insert("fuchsia", 0xFFFF00FF);
//         map.insert("purple", 0xFF800080);
//         map.insert("orange", 0xFFFFA500);
        
//         map
//     }
    
//     /// Extract colors from style attribute
//     /// Format: "fill:#RRGGBB; stroke:#RRGGBB; opacity:0.5"
//     pub fn extract_colors_from_style(style: &str) -> Vec<(String, u32)> {
...
//                         results.push((property.to_string(), color));
//                     }
//                 }
//             }
//         }
...
//     pub fn determine_token_from_class(css_class: &str) -> &'static str {
//         if css_class.contains("ds-primary") || css_class.contains("primary") {
//             "primary"
//         } else if css_class.contains("ds-secondary") || css_class.contains("secondary") {
//             "secondary"
//         } else if css_class.contains("ds-tertiary") || css_class.contains("tertiary") {
//             "tertiary"
//         } else {
//             "primary" // default
//         }
...
//     #[test]
//     fn test_parse_hex_3() {
//         assert_eq!(ColorParser::parse_color("#f00"), Some(0xFFFF0000));
//         assert_eq!(ColorParser::parse_color("#0f0"), Some(0xFF00FF00));
//     }
    
//     #[test]
//     fn test_parse_hex_6() {
//         assert_eq!(ColorParser::parse_color("#ff0000"), Some(0xFFFF0000));
//         assert_eq!(ColorParser::parse_color("#000000"), Some(0xFF000000));
//     }
    
//     #[test]
//     fn test_parse_none() {
//         assert_eq!(ColorParser::parse_color("none"), Some(0x00000000));
//     }
    
//     #[test]
//     fn test_parse_named() {
//         assert_eq!(ColorParser::parse_color("black"), Some(0xFF000000));
//         assert_eq!(ColorParser::parse_color("white"), Some(0xFFFFFFFF));
//     }
// }
