    ...
    static const std::vector<IofGroup> kCat = {
        ...
        { "Vegetation", {
            ...
            { 4070, "Vegetation, slow, good visibility", T::Area, S::Green, L::Green100Area, true,
              "Slow running but good visibility; green vertical stripes." },
        ...
        { "Course overprint", {
            ...
            { 7070, "Marked route",          T::Line, S::Purple, L::LowerPurple, false,
            ...
            { 7120, "First aid post",        T::Point, S::Purple, L::UpperPurple, true,
