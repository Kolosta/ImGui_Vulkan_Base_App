...
//     // 1. Charger toutes les icônes depuis le dossier
//     UI::IconManager::Instance().LoadIconsFromDirectory("resources/icons");
    
//     // 2. Appliquer toutes les configurations depuis IconConfigurations.h
//     // Simple et maintenable - un seul appel !
//     IconConfigurations::ApplyAllConfigs(UI::IconManager::Instance());
// }
...
void Application::LoadResources() {
    // SIMPLIFIED: Just load icons, auto-detection handles everything!
    UI::IconManager::Instance().LoadIconsFromDirectory("resources/icons");
    
    // No manual configuration needed - auto-detection works!
    // Icons with id="primary" and id="secondary" are auto-configured
    // Others stay in Original mode (showing SVG colors)
}
