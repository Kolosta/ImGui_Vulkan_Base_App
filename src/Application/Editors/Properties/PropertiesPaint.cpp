...
// ─────────────────────────────────────────────────────────────────────────────
//  Properties — the unified paint stack (docs/Ink/DOCUMENT_MODEL.md §4), full
//  legacy feature set: ordered MULTI fills and strokes, per-layer opacity,
//  solid or PATTERN fills (motif reference, spacing/offset/angle/scale, the
//  legacy fill CLIP — bounds / exact contour / inner or outer stroke edge —
//  and the lattice ANCHOR — object or document origin), stroke width spaces
//  (document units or viewport-px HAIRLINES), alignment/caps/joins/miter and
//  dashes. Layer reorder via Up/Down. Structural edits commit immediately;
//  drags fold into one undo command committed on release.
// ─────────────────────────────────────────────────────────────────────────────
