...
constexpr std::uint32_t kDocVersion = 6;   // v3: subpath spline params +
                                           //     anchor weight (+ dead marks)
                                           // v4/v5: generic marks (dead)
                                           // v6: marks — per-shape size unit,
                                           //     Fusion/Blend/Cut, 3 bend modes,
                                           //     front/behind, rect length+width
