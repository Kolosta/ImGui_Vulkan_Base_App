...
| Precision | Document coordinates **double**; GPU works in **view-relative float32** (camera subtracts origin on CPU in double) | Deep zoom on large documents without float wobble |
